...
TEST_F(MultisetTest, ConstIterator) {
  {
    s21::multiset<std::string>::const_iterator s21_it = mss21.begin();
    std::multiset<std::string>::const_iterator std_it = msstd.begin();
  ...
  {
    s21::multiset<std::string>::const_iterator s21_it = mss21.end();
    std::multiset<std::string>::const_iterator std_it = msstd.end();
    --s21_it;
    --s21_it;
    --std_it;
    --std_it;
...
TEST(multiset_lookup, count) {
  s21::multiset<int> my_mset1{66, 23, 1, 1, 1, 0};
